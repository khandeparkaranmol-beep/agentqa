...
export function SwimlaneDiagram({ agents, messages, onSelect, selected }: Props) {
        ...
        {messages.map((msg, idx) => {
          ...
          return (
            <g
              ...
              onMouseEnter={() => setHoveredTurn(msg.turn)}
            ...
            >
              ...
              {/* Sender dot */}
              <circle cx={x} cy={fromY} r={isSelected ? 7 : 5} fill={color} stroke="white" strokeWidth={1.5} />
              ...
              {/* Milestone badge */}
              {isMilestone && !isViolation && !isFault && (
                <g>
