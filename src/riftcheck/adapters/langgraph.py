...
class LangGraphAgent(AgentUnderTest):
    ...
    Example::
        ...
        from riftcheck.adapters.langgraph import LangGraphAgent
...
class LangGraphNodeAgent(AgentUnderTest):
    ...
    This adapter bridges between Riftcheck's message-based interface and
